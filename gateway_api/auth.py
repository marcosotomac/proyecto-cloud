...
async def get_current_user(
    ...
    try:
        ...
        # Support both 'sub' (standard JWT claim) and 'userId' (custom claim)
...
def get_auth_header(credentials: Optional[HTTPAuthorizationCredentials]) -> dict:
    """
    Get authorization header for proxying to services
    """
    if credentials is None:
        return {}
